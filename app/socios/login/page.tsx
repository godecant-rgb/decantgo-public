      ...
      <div className="mx-auto max-w-md">
        <section className="relative overflow-hidden rounded-[30px] border border-[rgba(223,190,86,0.18)] bg-[linear-gradient(135deg,#1f1812_0%,#271d12_55%,#18130f_100%)] p-6 shadow-[0_18px_40px_rgba(0,0,0,0.18)] md:p-8">
          ...
          <div className="relative">
            ...
            <h1 className="text-3xl font-bold text-[#f4e7c3]">
              Ingreso de socios
            </h1>
            <p className="mt-3 text-sm leading-7 text-[#e2cf9b]">
              Iniciá sesión para acceder al panel de gestión, compras, stock, cupones y analytics.
            </p>
            ...
            <form onSubmit={handleSubmit} className="mt-6 grid gap-4">
              <label className="block">
                <span className="mb-2 block text-sm font-medium text-[#e2cf9b]">
                  Usuario
                </span>
                <input
                  value={username}
              ...
              <button
                type="submit"
                disabled={loading}
                className="mt-2 rounded-full bg-[linear-gradient(135deg,#dfbe56_0%,#c89219_100%)] px-6 py-3 text-sm font-bold text-black shadow-[0_12px_28px_rgba(223,190,86,0.16)] transition hover:scale-[1.02] disabled:cursor-not-allowed disabled:opacity-60"
              >
